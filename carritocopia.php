...
<div id="cajacolumnas2">
  ...
  <h11>Suspendisse ut massa rhoncus, hendrerit mauris sed, luctus lacus. Duis auctor lacus nec lectus varius sollicitudin. Morbi posuere massa ut tortor commodo porta ut id elit. Aliquam sed malesuada libero. Suspendisse potenti. Phasellus in ante urna. </h11> 
    ...
    <h4>Seguir comprando</h4><br>
  </div>

    <form action="realizarVenta.php" method="post">
	<label>Datos para finalizar la compra</label><br><br>
	Nombre: <input type="text" name="nombre"><br>
	Apellido: <input type="text" name="apellido"><br>
	Dirección: <input type="text" name="direccion"><br>
	Ciudad: <input type="text" name="ciudad"><br>
	Correo: <input type="text" name="correo"><br>
	Notas sobre tu pedido: <textarea name="notas" class="input-text " id="notas" placeholder="ej. notas especiales para el envío." rows="2" cols="5"></textarea>
    <?php
	if($TotalVenta>0)
   	echo '<div id="botonmas"><h5><input type="submit" value="Comprar"></h5></div>';
	?>
