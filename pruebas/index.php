...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<header> 
        ...
        <div class="wrap">
        <div id="logo"> <a href="https://www.arropa.org"><img class="margenlogo" src="images/logo.png" alt=""/></a></div>
           ...
           <?php
			...
			<?php						
					...
					for ($i = 0; $i <$result->num_rows; $i++) {
						...
						echo '<div id="color'.$j.'">
						<div id="cajanoticiascolor"><h2><a id="enlaceNoticia" href="noticia.php?t='.$fila["nombre"].'"><span class="margennoticias">'.$fila["nombre"].'</span></a></h2>
			...
			<!--
            <div id="color1">
            <div id="cajanoticiascolor"><h2><span class="margennoticias">Noticia 1 TÍTULO</span></h2>
            <div class="margenfecha"><h14>Fecha 01/01/2015<br>
            <div class="parrafonoticia">Nunc tempus enim tempor lectus pretium, at commodo dui lobortis. Ut sed malesuada augue. Aenean a imperdiet dolor. </div></h14></div>
            </div></div>
            
            <div id="color2">
            <div id="cajanoticiascolor"><h2><span class="margennoticias">Noticia 1 TÍTULO</span></h2>
            <div class="margenfecha"><h14>Fecha 01/01/2015<br>
            <div class="parrafonoticia">Nunc tempus enim tempor lectus pretium, at commodo dui lobortis. Ut sed malesuada augue. Aenean a imperdiet dolor. </div></h14></div></div></div>
...
<footer>
  ...
  height="300" href="https://twitter.com/ArropaChile" data-widget-id="593314699988574208">Tweets por el @ArropaChile.</a> <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script></div>
    ...
    <img src="images/footer/logo_jump.png" alt=""/>
