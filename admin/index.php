...
<div class="container">
    <div class="page-header">
        <h2 class="text-center">Noticias del Sitio</h2>
    </div>
	<div class="table-responsive">
			<table class="table table-hover table-striped">
				...
				<tbody>
					...
					$sql="SELECT nombre, fecha, imagen FROM noticias ORDER BY fecha DESC";
					...
					for ($i = 0; $i <$result->num_rows; $i++) {
						...
						echo '<tr>
							<td>'.$fila["nombre"].'</td>
							<td>'.$fila["fecha"].'</td>
							<td class="col-sm-2"><img src="'.$fila["imagen"].'" class="img-rounded" width="60%"</td>
							<td><a href="editar.php?t='.$fila["nombre"].'"><span class="glyphicon glyphicon-edit text-primary"></span></a></td>
							<td><a href="#" data-toggle="modal" data-target="#myModal" onclick="funcionDelete(\''.$fila["nombre"].'\')">
			...
			<div class="modal-footer">
				<a href="agregar.php" class="btn btn-lg btn-default"><span class="glyphicon glyphicon-plus text-primary"></span>&nbsp;Nueva noticia</a>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	function funcionDelete(name) {
		...
		$("#text-modal").append("¿Está seguro de que desea eliminar la noticia <strong>" + name + "</strong>?");
	}
</script>
