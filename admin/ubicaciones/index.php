...
<div class="container">
    <div class="page-header">
        <h2 class="text-center">Ubicaciones de Productos</h2>
    </div>
	<div class="table-responsive">
			<table class="table table-hover table-striped">
				...
				<tbody>
					...
					$sql="SELECT * FROM ubicaciones ORDER BY nombre DESC";
			...
			<div class="modal-footer">
				<a href="agregar.php" class="btn btn-lg btn-default"><span class="glyphicon glyphicon-plus text-primary"></span>&nbsp;Nueva Ubicación</a>
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title text-center" id="myModalLabel">¿Eliminar Ubicación?</h4>
				</div>
...
<script type="text/javascript">
	function funcionDelete(name) {
		...
		$("#text-modal").append("¿Está seguro de que desea eliminar la ubicación <strong>" + name + "</strong>?");
	}
</script>
